    ...
    public class OceanRenderer : MonoBehaviour
    {
        ...
        void InitTimeProvider()
        {
            ...
            if (_timeProvider == null && (_timeProvider = GetComponent<TimeProviderBase>()) == null)
            {
                ...
                //if (nNum == 0)
                //    _timeProvider = gameObject.AddComponent<TimeProviderCustom>();
                //if (nNum == 1)
                //    _timeProvider = gameObject.AddComponent<TimeProviderCustom2>();
            }
        }
        ...
        void LateUpdateScale()
        {
           ...
           // transform.localScale = new Vector3(0.32f, 0.1f, 0.32f);
        }
